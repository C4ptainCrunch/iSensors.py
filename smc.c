...
const char* M_battery_health() {
    const char* health = getBatteryHealth();
    return health;
}

int M_battery_design_cycle_count() {
    return getDesignCycleCount();
}
